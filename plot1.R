...
##Plot and output
par(bg=NA)
hist(powercons$Global_active_power, xlab = "Global Active Power (kilowatts)", main = "Global Active Power", bg = NA ,col = "red", cex.lab = .75, cex.main = .75, cex.axis = .75)
